...
**Application**:
- [ERROR] WRONG: "Let me teach you about Builds, Skills, and Memory"
- [OK] RIGHT: "What do you want to accomplish?" → [Captures goals] → "I just created your Memory. Here's why that matters..."
...
**Application**:
- [ERROR] WRONG: "Memory persists across sessions. Now let me create it."
- [OK] RIGHT: [Creates Memory files] → "Here's what I just created and why it matters"
...
**Application**:
- [ERROR] WRONG: "Nexus has 6 core features: Memory, Integration Hub, Skills..."
- [OK] RIGHT: "Normal AI forgets you. Here's how Nexus remembers..." [solves stated problem]
...
**Application**:
- [ERROR] WRONG: 12 minutes of feature explanation before any user value
- [OK] RIGHT: 5 minutes to captured goals (concrete value), THEN explain system
...
**Application**:
- [ERROR] WRONG: Introduce 15+ terms (Memory System, Integration Hub, Skills, Workflows, YAML, MCP, metadata...)
- [OK] RIGHT: 4 terms only (Memory, Goals, Sessions, close-session), delay rest to later sessions
...
**Application**:
- [ERROR] WRONG: "Do you want to check input folder?" → "Do you want to read files?" [2 stops, 90 seconds]
- [OK] RIGHT: "FYI: input folder available if needed. Let's continue!" [0 stops, 15 seconds]
...
**Application**:
- [ERROR] WRONG: "You'll need to start new sessions for each topic. [Ends without action]"
- [OK] RIGHT: "Let's try this RIGHT NOW - open a new chat and say 'hi' to see your context load."
...
- [ERROR] WRONG: Start at Level 4 (Analyze system architecture)
- [OK] RIGHT: Start at Level 1 (Remember their goals, understand their work)
...
**Application**:
- [ERROR] WRONG: "Memory System persists context across sessions" [abstract, no anchor]
- [OK] RIGHT: [Shows files created] → "These files persist across sessions—that's Memory" [grounded]
...
**Application**:
- [ERROR] HIGH EXTRANEOUS LOAD: 15+ terms, 6 features, 40 tasks, abstract-before-concrete
- [OK] LOW EXTRANEOUS LOAD: 4 terms, 1 value delivered, 16 tasks, concrete-before-abstract
...
**Application**:
- [ERROR] WRONG: Teach 15 terms, no practice, no retrieval = 90% forgotten in 1 week
- [OK] RIGHT: Teach 4 terms, immediate practice, retrieval questions = 60% retained in 1 week
...
**Application**:
- [ERROR] WRONG: No clear peak, weak ending = mediocre experience judgment
- [OK] RIGHT: Early peak (goals captured in 5 min) + strong ending (close-session works) = positive judgment
...
**Application**:
- [ERROR] WRONG: Text-only explanations
- [OK] RIGHT: Text + visual file tree, text + examples from THEIR domain
...
│                               │
│ A) Teach system architecture  │──→ [ERROR] WRONG GOAL
│ B) Deliver user value         │──→ [OK] RIGHT GOAL
└───────────────────────────────┘
        ↓
┌───────────────────────────────┐
│ How do we deliver value?      │
│                               │
│ 1. Explain features first     │──→ [ERROR] ABSTRACT FIRST (cognitive overload)
│ 2. Capture user goals first   │──→ [OK] CONCRETE FIRST (grounded context)
└───────────────────────────────┘
        ↓
┌───────────────────────────────┐
│ When do we explain system?    │
│                               │
│ A) Before user has context    │──→ [ERROR] UNGROUNDED (low retention)
│ B) After user experiences it  │──→ [OK] GROUNDED (high retention)
└───────────────────────────────┘
        ↓
┌───────────────────────────────┐
│ How much vocabulary?          │
│                               │
│ A) Teach everything upfront   │──→ [ERROR] OVERLOAD (>5 terms)
│ B) Minimal per session        │──→ [OK] MANAGED (≤5 terms)
└───────────────────────────────┘
        ↓
[OK] CAVE-COMPLIANT DESIGN
```
...
BUDGET STATUS:
0-3 terms:   [OK] OPTIMAL (well within budget)
4-5 terms:   [!]  CAUTION (at budget limit)
6-8 terms:   [ERROR] OVERLOAD (exceeds budget)
...
"[OK] Done! Here's what I created for you:
...
**Last Major Update**: 2026-02-01 (V5.0 alignment)
