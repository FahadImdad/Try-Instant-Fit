    ...
    try:
        if args.command == "read":
            ...
            if args.json:
                ...
                print(f"[OK] Inserted {result['text_length']} characters at index {result['inserted_at']}")
            ...
            if args.json:
                ...
                print(f"[OK] Appended {result['text_length']} characters")
            ...
            if args.json:
                ...
                print(f"[OK] Replaced {result['occurrences_changed']} occurrences")

        elif args.command == "export":
            result = export_document(args.document_id, args.format, args.output)
            if args.output:
                print(f"[OK] Exported to: {result['exported_to']}")
            else:
                print(result)
            ...
            if args.json:
                ...
                print(f"[OK] Copied to: {result['title']}")
                print(f"ID: {result['document_id']}")
                print(f"URL: {result['url']}")

        elif args.command == "clear":
            result = clear_document(args.document_id)
            print(f"[OK] Cleared document")
            ...
            if args.json:
                ...
                print(f"[OK] Renamed to: {result['title']}")
                print(f"URL: {result['url']}")
