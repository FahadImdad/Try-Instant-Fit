...
### With Limit
```bash
uv run python 00-system/skills/hubspot/hubspot-master/scripts/list_companies.py --limit 25 --json
```

### With Pagination
```bash
uv run python 00-system/skills/hubspot/hubspot-master/scripts/list_companies.py --after "cursor_value" --json
```
