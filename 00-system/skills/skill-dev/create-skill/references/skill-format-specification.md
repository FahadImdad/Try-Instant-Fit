...
- [ERROR] README.md
- [ERROR] INSTALLATION_GUIDE.md
- [ERROR] QUICK_REFERENCE.md
- [ERROR] CHANGELOG.md
- [ERROR] Setup/testing documentation
- [ERROR] User-facing guides
...
Required checks:
- [OK] YAML has only `name` and `description`
- [OK] Name is hyphen-case
- [OK] Description is comprehensive and specific
- [OK] Body contains actionable instructions
- [OK] File is under 500 lines (or split appropriately)
- [OK] No extraneous files (README, etc.)
- [OK] Referenced resources exist
- [OK] Scripts are tested and functional
