...
```
[OK] pdf-editor
[OK] client-proposal-generator
[OK] weekly-status-report
[OK] analyze-sales-data

[ERROR] pdf_editor          (underscores)
[ERROR] pdfEditor           (camelCase)
[ERROR] PDF-Editor          (uppercase)
[ERROR] pdf editor          (spaces)
```
...
**Too long:**
```
[!]  generate-comprehensive-weekly-status-report-with-metrics
