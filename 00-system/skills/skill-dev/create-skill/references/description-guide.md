...
```
[ERROR] PDF tool
[ERROR] Generates reports
```

**Good:**
```
[OK] Process PDF documents - rotate pages, extract text, fill forms, and merge files. Use when working with PDF files that need manipulation or data extraction. Supports both single operations and batch processing.
```
...
Result: [OK] Should match (mentions "process PDF documents")

Test: "Analyze this spreadsheet"
Result: [ERROR] Shouldn't match (different file type)
```
...
type: workflow        # [ERROR] Remove
triggers: [...]       # [ERROR] Remove
version: 1.0          # [ERROR] Remove
---
```
