...
After understanding the skill requirements, AI **runs** `uv run nexus-mental-models --format brief` to see available thinking frameworks, then offers 2-3 relevant options to deepen skill design.
...
**When to Offer**:
- [OK] After understanding concrete examples (Step 2)
- [OK] Before planning reusable contents (Step 3)
- [OK] When skill design has complexity or unknowns
- [ERROR] Skip for simple, straightforward skills (user can decline)
...
**Benefits**:
- [OK] **Deeper analysis** - Mental models surface edge cases and risks
- [OK] **User choice** - User decides if/when to apply structured thinking
- [OK] **Efficient** - Brief descriptions (3-7 words), progressive disclosure
- [OK] **Quality** - Better skill design through systematic thinking

**See**: [`mental-models skill`](../tools/mental-models/SKILL.md) for usage
...
AI: [UPLOAD] Ready to push skill to Notion:
    Skill Name: my-skill
    Team: General
    Owner: Your Name
...
- [OK] Purpose section exists (used for Notion Purpose field)
- [OK] Description is specific (not generic)
- [OK] Integration tags detected (helps with Team inference)
- [!] Warnings about missing elements (won't block export)
...
```bash
nexus-load --skill close-session
```
