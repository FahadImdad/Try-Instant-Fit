...
1. [OK] Analyzes implementation code (scripts, core logic)
2. [OK] Identifies what the code actually creates/does
3. [OK] Searches all documentation for references to those entities
4. [OK] Compares documented behavior vs actual behavior
5. [OK] Fixes all mismatches systematically
6. [OK] Provides summary of changes made
...
[OK] **All counts** match actual artifact counts
[OK] **All file references** use current names
[OK] **User can follow docs** without confusion
