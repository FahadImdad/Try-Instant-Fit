...
**[!] AUTOMATIC BULK-COMPLETION CHECK** (MANDATORY - 10+ TASK THRESHOLD):
...
**Execute**:
```bash
nexus-bulk-complete --build [build-id] --all --no-confirm
```
...
- Script displays: `[OK] VALIDATED: Re-read file shows 0 uncompleted, [N] completed`
- Display to user: "[OK] Marked [N] tasks as complete! Progress: 100%"
...
- Run: `nexus-bulk-complete --build [build-id] --all --no-confirm`
- Script will mark ALL unchecked tasks as `[x]` without confirmation
- Script validates by re-reading file
- Display script output: "[OK] VALIDATED: Re-read file shows 0 uncompleted, [N] completed"
- Display: "[OK] Marked [N] tasks as complete!"
- Recalculate progress (should now be 100%)
...
- Display: "[OK] workspace-map.md updated and validated"
...
Did I:
[OK] Use TodoWrite at the beginning?
[OK] Pause after each document for your review?
[OK] Wait for your confirmation before proceeding?
[OK] Collaborate with you instead of just generating?
...
Maps Updated:
- workspace-map: [[OK] Accurate or [!] Needs update]
...
-------------------------------------------------------
[SYNC] IMPORTANT: Start a Fresh Session
-------------------------------------------------------
...
This ensures:
[OK] Clean context for next session
[OK] Fresh loading of updated build state
[OK] Proper memory boundaries
[OK] No context pollution from previous session
